...
import com.etsisi.dev.etsisicrowdsensing.EventRepository;
import com.etsisi.dev.etsisicrowdsensing.EventRoomDatabase;
...
public class CompletedEventAlarmService extends IntentService{
    private static final String TAG = "CompletedEvAlarmService";
    ...
    public CompletedEventAlarmService() {
        super("CompletedEventAlarmService");
    }
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        //EventViewModel mEventViewModel = ViewModelProviders.of(CampusFragment.this).get(EventViewModel.class);
        //mEventViewModel.remove(event);

        EventRepository mRepository = new EventRepository(getApplication());

        EventRoomDatabase db = EventRoomDatabase.getDatabase(getApplicationContext());
    ...
    private void showEventNotification(Event event) {
        ...
        NotificationCompat.BigTextStyle bigTextStyle = new NotificationCompat.BigTextStyle()
                ...
                .bigText("¡Tienes " + kind.toLowerCase() + " de la asignatura de " + event.getSubject() + "!")
                // Overrides ContentTitle in the big form of the template.
                .setBigContentTitle("¡Tienes " + kind.toLowerCase() + " de la asignatura de " + event.getSubject() + "!" )
        ...
        Notification notification = notificationCompatBuilder
                ...
                .setContentText(kind + " de " + event.getSubject() + ".")
